...
if __name__ == '__main__':
    tweets_dir = os.path.join(os.getenv('D'), 'full-tweets-with-misinfo-and-news', 'retweets')
    dest = os.path.join(os.getenv('D'), 'measures', 'retweet-analysis', 'retweets-misinfo.tab')
